...
<p style="margin: 0; font-size: 14px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;"><strong><span style="font-size: 30px;">Nouvelle Souscription</span></strong></p>
...
<p style="margin: 0; font-size: 14px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">{{ $params["user_firstname"] }} {{ $params["user_lastname"] }} (ID: {{ $params["user_id"] }}) a souscrit à un abonnement.</p>
